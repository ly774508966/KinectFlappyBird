		...
		if(kinectInitialized)
		{
	        if(computeUserMap && displayUserMap)
	        {
				if(usersMapRect.width == 0 || usersMapRect.height == 0)
				{
					...
					//usersMapRect = new Rect(cameraRect.width - displayWidth - 20f, cameraRect.height - 20, displayWidth, -displayHeight);
                    usersMapRect = new Rect(20f, cameraRect.height - 40f, displayWidth, -displayHeight);
				}
